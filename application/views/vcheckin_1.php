               ...
               <div class="col-md-6 col-12 p-0">
                  <div class="home-background-white">
                     <div class="home-background-text-container">
                        <h5 class="text-center home-background-black-text" style="padding-top: 2ch;">
                           Secure Access Vania Showroom
                        </h5>
                        <div class="card-signin" style="padding-top: 1ch;">
                           <form class="form-signin"  id="form-signin">
                              ...
                              <div class="form-label-group">
                                  <input disabled="" value="dsa dsa" type="text" name="quest_name" id="quest_name" class="form-control" placeholder="Name" required autofocus>
                              ...
                              <div class="col-12">
                                ...
                                <hr>
                              <button onclick="myFunctionFORM()" disabled id="btn-submit" class="btn btn-mini darkness btn-checkin btn-block text-uppercase" type="submit">Checkin</button>
                           </form>
       ...
       <script>
        ...
        $(document).ready(function() {
           setTimeout(function(){  getLocation(); 
            x.innerHTML = '<span class="fa fa-spinner fa-spin" aria-hidden="true"></span>Loading..';       
            }, 1000);
        ...
        success: function(result) {
            ...
            if (result != "") {
               ...
               var showroom_address =result[0].showroom_address;
                ...
                locations.innerHTML = "Checkin from: <b>" + showroom_name +"</b> &nbsp;(" + showroom_address + ")";
